...
frames_directory = r"C:\Users\User\Desktop\Git\Блокноты\Скрипт для разметки\Скрипт для разметки\frames"
# Установка пути к директории с аннотациями
annotations_directory = r"C:\Users\User\Desktop\Git\Блокноты\Скрипт для разметки\Скрипт для разметки\annotations"
